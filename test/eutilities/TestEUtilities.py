...
class TestQueries(unittest.TestCase):
    ...
    def test_query_class(self):
        ...
        q2 = EUtilities.Query('2009', ['cancer', 'asthma'])
    ...
    def test_search(self):
        ...
        result = EUtilities.search(EUtilities.DATABASES.PubMed, q)
    ...
    def test_fetch(self):
        ...
        # Creating the query
        q = EUtilities.Query(pdat="2009", mesh=['asthma', 'leukotrienes'])

        # Fetching result from PubMed database based on the query
        result = EUtilities.fetch(EUtilities.DATABASES.PubMed, q)
        ...
        q2 = EUtilities.Query(any_terms=["20113659"])

        # Fetching result with new query
        result2 = EUtilities.fetch(EUtilities.DATABASES.PubMed, q2)
    ...
    def test_fetch_articles(self):
        ...
        q = EUtilities.Query(any_terms=["20113659"])

        # Fetching articles
        articles = EUtilities.fetch_articles(EUtilities.DATABASES.PubMed, q)
    ...
    def test_search_by_pmid(self):
        ...
        response = EUtilities.search_by_pmid(20180383)
    ...
    def test_extract_ids(self):
        ...
        # Creating the query
        q = EUtilities.Query('2009', ['cancer', 'asthma'])

        # Getting the response
        response = EUtilities.search(EUtilities.DATABASES.PubMed, q)

        # Extracting the IDs given the response's content
        ids = EUtilities.extract_ids(str(response.content))
